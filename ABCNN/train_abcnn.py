    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            def train_step(batch_data):
                ...
                feed_dict = {
                    abcnn.input_x_front: x_f,
                    abcnn.input_x_behind: x_b,
                    abcnn.input_y: y_onehot,
            ...
            def validation_step(val_loader, writer=None):
                ...
                for batch_validation in batches_validation:
                    ...
                    step, summaries, predictions, cur_loss = sess.run(
                        [abcnn.global_step, validation_summary_op, abcnn.topKPreds, abcnn.loss], feed_dict)
